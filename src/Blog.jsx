...
export const Blog = () => {
    ...
    return (
        <motion.div {...pageTransition} className="container section" style={{ position: 'relative' }}>
            <div className="bg-shape-1" style={{ top: '-5%', left: '-5%', width: '40vw', height: '40vw' }}></div>
            <div className="bg-shape-2" style={{ bottom: '-5%', right: '-5%', width: '40vw', height: '40vw' }}></div>

            <div style={{ position: 'relative', zIndex: 2 }}>
                <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
                    <BookOpen size={48} color="var(--accent-gold)" style={{ margin: '0 auto 1.5rem' }} />
                    <h1 style={{ fontSize: '3rem', marginBottom: '1rem' }}>Datosahora <span className="text-gradient">Blog</span></h1>
